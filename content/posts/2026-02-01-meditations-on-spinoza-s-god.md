...
When we introspect, and introspection is itself a process within the self-model, not a window onto some separate realm, we encounter the self-model's outputs. We experience ourselves as experiencing because the self-model represents experience as a property of the self. The felt quality of experience, the "what it is like" that seems so resistant to functional explanation, is generated by the model. 
