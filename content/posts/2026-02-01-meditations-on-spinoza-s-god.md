...
When we introspect, and introspection is itself a process within the self-model, not a window onto some separate realm, we encounter the self-model's outputs. The felt quality of experience, the "what it is like" that seems so resistant to functional explanation, is generated by the model.

And this explains why experience has the particular texture it does, why anything feels good or bad, why we want some things and recoil from others. Emotions are not decorations added to cognitive machinery. They are the felt imperatives of a system that must maintain itself far from equilibrium.

Hunger is how a dissipative structure experiences a metabolic deficit requiring correction. Fear is how it experiences a predicted threat to its continued existence. Pleasure marks actions that have historically sustained the system; pain marks damage or depletion. Desire is the felt pull toward states that reduce uncertainty and keep the organism in the game. Every emotion roots back to the same imperative: stay far from equilibrium, keep dissipating, persist. We do not have emotions despite being entropy-producing machines. We have emotions because we are entropy-producing machines that must navigate the world to keep producing.
